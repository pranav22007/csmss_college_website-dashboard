...
// Fetch forms
$sql = "SELECT * FROM college_timetable ORDER BY id ASC";
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">College Timetable</li>
                                </ol>
                            </nav>
                                ...
                                <div class="widget event-single-info mt-5">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            $sql = "SELECT * FROM college_timetable ORDER BY id DESC";
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                 ...
                                                 <div class="choose-item m-3">
                                                     ...
                                                     <div class="choose-item-info d-flex align-items-center justify-content-between">
                                                           <!-- Title from DB -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/college_timetable/' . $row['pdf'] . '" class="flex-grow-1" target="_blank">
                                                              <p class="mt-0 mb-0">' . htmlspecialchars($row['title']) . '</p>
                                                          </a>

                                                           <!-- Download Button -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/college_timetable/' . $row['pdf'] . '" download class="download-btn ms-3">

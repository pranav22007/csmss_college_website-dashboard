                ...
                <div class="department-single-wrapper">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12"
                            style="overflow-y:scroll; height: 600px; scrollbar-width: none; -ms-overflow-style: none;">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="widget event-single-info mt-5">
                                    ...
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        <h4 class="widget-title mt-5 text-center">Exam Timetable</h4>
                                    </button>
                                    </h2>
                                    <?php
                                    include('csmss_poly_dashboard/common/dbcon.php');

                                    $sql = "SELECT * FROM exam_timetable ORDER BY exam_id DESC";
                                            ...
                                            echo '<div class="col-lg-12 col-md-12">
                                                 <div class="choose-item m-3">
                                                     ...
                                                     <div class="choose-item-info d-flex align-items-center justify-content-between">
                                                           <!-- Title from DB -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/exam_timetable/' . $row['pdf'] . '" class="flex-grow-1" target="_blank">
                                                              <p class="mt-0 mb-0">' . htmlspecialchars($row['title']) . '</p>
                                                          </a>

                                                           <!-- Download Button -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/exam_timetable/' . $row['pdf'] . '" download class="download-btn ms-3">

...
$stmt = $conn->prepare("SELECT * FROM faculty_details WHERE department = ?");
                                            ...
                                            if ($toppers->num_rows > 0) {
                                                ...
                                                while ($row = $toppers->fetch_assoc()) {
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href='edit_Faculty-Details.php?id={$row['id']}' class='btn rounded-pill btn-primary'>
                                                                <i class='bx bx-edit-alt me-1'></i> Edit
                                                            </a>
                                                            <a href='delete_Faculty-Details.php?id={$row['id']}' onclick=\"return confirm('Are you sure you want to delete this record?');\" class='btn rounded-pill btn-danger'>
                                                ...
                                                echo "<tr><td colspan='7' class='text-center'>No Faculty-Details found for $deptName</td></tr>";
                                            }
                                            ?>
                                            </tbody>
                                        </table>

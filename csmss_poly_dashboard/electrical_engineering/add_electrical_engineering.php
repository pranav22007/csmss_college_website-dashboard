...
if (isset($_POST['add_btn'])) {
    ...
    $upload_dir = __DIR__ . "/../assets/pdf/electrical_engineering/";
    ...
    if (move_uploaded_file($file_tmp, $file_path)) {
        ...
        $query = "INSERT INTO electrical_engineering (subject_code, pdf) 
              VALUES ('$subject_code', '$file_name')";
        $query_run = mysqli_query($conn, $query);

        if ($query_run) {
            header("Location: electrical_engineering.php");
            exit();
        } else {

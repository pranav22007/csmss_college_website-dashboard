...
if (isset($_POST['submit'])) {
  ...
  $imageuploadpath = '../assets/img/news-events/news-media/';
  ...
  if (move_uploaded_file($imageTmpName, $targetFilePath)) {
    $sql = "INSERT INTO news_media (title, image)
                VALUES ('$title','$targetFilePath')";
               ...
               <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                     <div class="col-lg-12 mt-3 text-center">
                       <button type="submit" name="submit" class="btn btn-primary">Add News Media</button>

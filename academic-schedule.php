                        ...
                        <div class="col-xl-12 col-lg-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Academic Schedule</li>
                                </ol>
                            </nav>
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="widget event-single-info mt-5">
                                    ...
                                    $sql = "SELECT * FROM academic_schedule ORDER BY aca_id DESC";
                                            ...
                                            echo '<div class="col-lg-12 col-md-12">
                                                 <div class="choose-item m-3">
                                                     ...
                                                     <div class="choose-item-info d-flex align-items-center justify-content-between">
                                                           <!-- Title from DB -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/academic_schedule/' . $row['pdf'] . '" class="flex-grow-1" target="_blank">
                                                              <p class="mt-0 mb-0">' . htmlspecialchars($row['title']) . '</p>
                                                          </a>

                                                           <!-- Download Button -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/academic_schedule/' . $row['pdf'] . '" download class="download-btn ms-3">

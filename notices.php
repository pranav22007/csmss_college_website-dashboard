        ...
        <div class="department-single-area py-120 faq-area">
            <div class="container">
                <div class="department-single-wrapper">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12"  style="overflow-y:scroll; height: 450px; scrollbar-width: none; -ms-overflow-style: none;">
                                                ...
                                                echo '<div class="col-lg-12 col-md-12">
                                                 <div class="choose-item m-3">
                                                     ...
                                                     <div class="choose-item-info d-flex align-items-center justify-content-between">
                                                           <!-- Title from DB -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/notice/' . $row['pdf'] . '" class="flex-grow-1" target="_blank">
                                                              <p class="mt-0 mb-0">' . htmlspecialchars($row['title']) . '</p>
                                                          </a>

                                                           <!-- Download Button -->
                                                           <a href="../csmss-polytechnic-website/csmss_poly_dashboard/assets/pdf/notice/' . $row['pdf'] . '" download class="download-btn ms-3">
